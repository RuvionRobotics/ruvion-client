...
2. Run:  python examples/gravity_comp.py
"""
import asyncio
import logging
...
async def main() -> None:
    ...
    async with conn:
        ...
        async with conn.claim():
            ...
            print("  Starting gravity compensation calibration...")
            await conn.calibrate(CalibrationType.Gravity)
            print("  ✓ Gravity compensation calibration complete")
